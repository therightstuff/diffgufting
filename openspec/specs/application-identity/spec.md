...
Development and packaged launches SHALL display diffgusting as the application menu name on platforms with an application menu, rather than Electron. Existing native menu actions SHALL remain available. Identity initialization SHALL preserve access to existing preferences and recent comparisons.

#### Scenario: Launch on macOS

- **WHEN** a development or packaged build opens
- **THEN** the application menu is named diffgusting and native Quit and Hide actions remain available
